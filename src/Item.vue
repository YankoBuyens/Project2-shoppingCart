<template>
  <div class="col-sm-4 item">
    <div class="card text-center" >
      <div>
        <img :src="item.thumbnail_url" alt="" class="card-img-top grow" style="max-height: 250em; max-width: 250em;">
      </div>
      <div class="card-body">
        ...
        <p class="card-text">{{item.country}}, {{item.holiday_type}}</p>
        <p class="card-text">From:{{item.departure_date}} - Until:{{item.return_date}}</p>
        <div class="row">
